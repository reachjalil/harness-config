...
- **Conventional commits / SemVer / RFC 2119** ont inspiré le langage normatif explicite et la politique de compatibilité ascendante dans [Standard](/specifications/v1/standard/). Une spécification que les futurs implémenteurs peuvent lire isolément a plus de chance de survivre à un changement de mainteneur.
