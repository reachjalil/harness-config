...
socialTitle: Why .harness separates source catalogs from harness surfaces
description: Why the standard separates a durable source catalog, generated harness surfaces, and runtime-owned mutable state.
socialDescription: The design rationale for treating harness surfaces as generated projections while keeping runtime-owned mutable state out of canonical source.
canonicalPath: /specifications/v1/rationale/
slug: rationale
order: 1
locale: en
sectionCode: "01"
summary: Why the standard separates a durable source catalog from live harness surfaces and runtime-owned mutable state.
llmSummary: Explains why live harness surfaces should be derived outputs while .harness remains the reviewable source of truth, including profiles, target-output controls, runtime-owned mutable files, and composable instruction files.
