---
title: Adoption
seoTitle: Adopting .harness Config
socialTitle: How to adopt .harness in a repository
description: Practical workflows for greenfield setup, migration, runtime-owned mutable files, profiles, composable instructions, and cleanup.
socialDescription: A practical adoption path for moving agent configuration into a durable .harness source catalog while preserving runtime-owned mutable state.
canonicalPath: /specifications/v1/adoption/
slug: adoption
order: 4
locale: en
sectionCode: "04"
summary: Practical workflows for greenfield setup, migration, runtime-owned mutable files, profiles, composable instructions, and cleanup.
llmSummary: Covers practical workflows for creating a .harness catalog, declaring targets, previewing activation, migrating harness surfaces, marking runtime-owned mutable files, using profile overlays, and keeping target cleanup safe.
