...
description: Practical workflows for greenfield setup, migration, profiles, composable instructions, and cleanup.
socialDescription: A practical adoption path for moving agent configuration into a durable .harness source catalog with profiles and safe target cleanup.
