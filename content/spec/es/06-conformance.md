...
- Las implementaciones MUST soportar `.harnessProfileIsolation` cuando exista dentro de una raíz de perfil activa, suprimiendo candidatos de recursos y dir no-perfil coincidentes mientras preservan raíces de perfil activas con el mismo nombre y rutas no relacionadas.
