...
Cuando `[dir]` esta declarado, las hojas `.harnessComposable` componen partes numeradas y el resto de archivos se copia hacia rutas relativas al repositorio. Los `.harnessIgnore` de fuente filtran la recoleccion y los `.harnessIgnore` de salida filtran resultados finales.
