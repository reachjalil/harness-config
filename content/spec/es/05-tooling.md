...
description: Implementacion npx harnessc, validacion, introspeccion explain, planificacion, activacion y comandos de limpieza.
...
locale: es
sectionCode: "05"
summary: "Implementacion npx harnessc: validacion, introspeccion explain, planificacion, activacion y limpieza."
llmSummary: Describe expectativas de herramientas para validacion, introspeccion explain, perfiles, dry-run, activacion, diagnosticos, limpieza y helpers alrededor de .harness.
...
`npx harnessc` es la implementacion estandar para validar, planificar, explicar y activar Harness config.
...
`npx harnessc explain <path>` es introspeccion de solo lectura para una ruta fuente o de salida. Ejemplos:
