...
يمكن تجاهل واجهات التشغيل المولّدة في Git عندما يحتفظ المستودع بمسار تفعيل متتبع. يبقى البيان وفهرس المصدر في التحكم بالإصدارات؛ ويمكن إعادة توليد المجلدات المباشرة بعد جلب نسخة جديدة.
